...
// tslint:enable:no-any interface-name
...
export function getBrowser(): IBrowser {
    ...
    browser = {
        ...
        opera: (!!(window as any).opr && !!opr.addons) || !!(window as any).opera || navigator.userAgent.indexOf(' OPR/') >= 0,
    ...
    $('html')
        ...
        .toggleClass('windows', browser.windows && !browser.mac && !browser.ios)
